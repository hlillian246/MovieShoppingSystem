...
public class TransactionModel {
    ...
    public TransactionModel(String transactionId, String state, AmountModel amount, TransactionFee transaction_fee, String create_time, String update_time, List<OrderItemModel> items) {
