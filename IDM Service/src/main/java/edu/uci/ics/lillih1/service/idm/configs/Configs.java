package edu.uci.ics.lillih1.service.idm.configs;

import edu.uci.ics.lillih1.service.idm.logger.ServiceLogger;
import edu.uci.ics.lillih1.service.idm.models.ConfigsModel;
    ...
    public Configs(ConfigsModel cm) throws NullPointerException {
        if (cm == null) {
            ...
            if(expiration < 0)
            {
                ...
                System.err.println("Wrong expiration found in configuration file. Using default");
            }
            else
            {
                System.err.println("Session expiration: " + expiration);
            }
            ...
            {
                System.err.println("Session timeout: " + timeout);
            }
